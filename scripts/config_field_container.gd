...
func to_ue(key) -> String:
	match key:
		...
		KEY_END: return "END"
		KEY_LEFT: return "LEFT_ARROW"
		KEY_UP: return "UP_ARROW"
		KEY_RIGHT: return "RIGHT_ARROW"
		KEY_DOWN: return "DOWN_ARROW"
		KEY_PAGEUP: return "PAGE_UP"
		KEY_PAGEDOWN: return "PAGE_DOWN"
		KEY_CAPSLOCK: return "CAPS_LOCK"
		KEY_NUMLOCK: return "NUM_LOCK"
		KEY_SCROLLLOCK: return "SCROLL_LOCK"
		KEY_F1: return "F1"
		KEY_F2: return "F2"
		KEY_F3: return "F3"
		KEY_F4: return "F4"
		...
		KEY_F23: return "F23"
		KEY_F24: return "F24"
		KEY_KP_MULTIPLY: return "MULTIPLY"
		KEY_KP_DIVIDE: return "DIVIDE"
		KEY_KP_SUBTRACT: return "SUBTRACT"
		KEY_KP_PERIOD: return "DECIMAL"
		KEY_KP_ADD: return "ADD"
		KEY_KP_0: return "NUM_ZERO"
		KEY_KP_1: return "NUM_ONE"
		KEY_KP_2: return "NUM_TWO"
		KEY_KP_3: return "NUM_THREE"
		KEY_KP_4: return "NUM_FOUR"
		KEY_KP_5: return "NUM_FIVE"
		KEY_KP_6: return "NUM_SIX"
		KEY_KP_7: return "NUM_SEVEN"
		KEY_KP_8: return "NUM_EIGHT"
		KEY_KP_9: return "NUM_NINE"
		KEY_HELP: return "HELP"
		KEY_VOLUMEDOWN: return "VOLUME_DOWN"
		KEY_VOLUMEMUTE: return "VOLUME_MUTE"
		KEY_VOLUMEUP: return "VOLUME_UP"
		KEY_MEDIAPLAY: return "MEDIA_PLAY_PAUSE"
		KEY_MEDIASTOP: return "MEDIA_STOP"
		KEY_MEDIANEXT: return "MEDIA_NEXT_TRACK"
		KEY_MEDIAPREVIOUS: return "MEDIA_PREV_TRACK"
		KEY_LAUNCHMAIL: return "LAUNCH_MAIL"
		KEY_LAUNCHMEDIA: return "LAUNCH_MEDIA_SELECT"
		KEY_PLUS: return "OEM_PLUS"
		KEY_COMMA: return "OEM_COMMA"
		KEY_MINUS: return "OEM_MINUS"
		...
		KEY_FAVORITES: return "BROWSER_FAVORITES"
		KEY_SEARCH: return "BROWSER_SEARCH"
		KEY_FORWARD: return "BROWSER_FORWARD"
		KEY_BACK: return "BROWSER_BACK"
		_:
	...
	if regex != null:
		...
		match config_field.type.arg_enum:
			...
			ArgEnum.FLOAT_PRECISION_RANGE:
				...
				if chars_after_dot > config_field.type.precision or \
